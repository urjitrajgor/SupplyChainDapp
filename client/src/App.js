    ...
    return (
      <div className="App">         
        <div class="jumbotron">
          ...
          <div class= "col-sm-12 text-center" style={{ textAlign: 'center' }}>
            ...
            <button class = "btn-primary" onClick={this.newAssets} id="createAsset">Create Asset</button>
          </div>
          ...
          <div class= "col-sm-12 text-center" style={{ textAlign: 'center' }}>
            ...
            <button class="btn-primary" onClick={this.transferAssets} id="transferAsset">Transfer Asset</button>
          </div>

          <div class= "col-sm-12 text-center" style={{ textAlign: 'center' }}>
            <label><b>Track Asset Details:</b></label>
            <input type="number" id="trackUuid" placeholder="UUID" required />
            <button class="btn-primary" onClick={this.trackAsset} id="trackAsset">Track Asset Details</button>
          </div>
          ...
          <div id="response text-center" style={{ textalign:'center'}}>
            ...
            <p><b>Current Location:</b><span id="location">{this.state.assets[2] === null? '': this.state.assets[2]}</span></p>
          </div>
      </div>
    );
  }
